...
const styles = StyleSheet.create({
  ...
  greeting: { fontSize: TYPOGRAPHY.greeting, fontWeight: FONT_WEIGHT.bold, color: COLORS.textPrimary, textAlign: 'center' },
  cycleCard: { borderWidth: 1, borderColor: '#FCE4EC', backgroundColor: COLORS.white },
  cycleDayLabel: { fontSize: 14, fontWeight: FONT_WEIGHT.bold, color: COLORS.textSecondary, textAlign: 'center', marginBottom: 4 },
  cycleDayNumber: { fontSize: TYPOGRAPHY.cycleDay, fontWeight: FONT_WEIGHT.bold, color: COLORS.primary, textAlign: 'center', marginBottom: 4 },
  cycleDayInfo: { fontSize: 14, fontWeight: FONT_WEIGHT.bold, color: COLORS.textSecondary, textAlign: 'center' },
  ...
  weekDayText: { fontSize: 14, fontWeight: FONT_WEIGHT.bold, color: COLORS.textSecondary, width: 40, textAlign: 'center' },
  datesGrid: { flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'center', gap: 8 },
  dateBox: { width: 40, height: 40, borderWidth: 1, borderColor: COLORS.border, borderRadius: 8, justifyContent: 'center', alignItems: 'center' },
  selectedDateBox: { borderColor: COLORS.primary, borderWidth: 2, backgroundColor: COLORS.primaryLight },
  emptyDateBox: { backgroundColor: 'transparent', borderColor: 'transparent' },
  dateText: { fontSize: 16, fontWeight: FONT_WEIGHT.bold, color: COLORS.textPrimary },
